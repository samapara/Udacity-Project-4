[![CircleCI](https://circleci.com/gh/samapara/Udacity-Project-4.svg?style=svg)](https://app.circleci.com/pipelines/github/samapara/Udacity-Project-4)
...
4c01db0b339q        ubuntu:18.04                 bash                   17 seconds ago       Up 16 seconds       3300-3310/tcp       webapp
```
...
-   Define a `dockerpath` which is `<docker_hub_username>/<project_name>` e.g: `shubhammapara/udacity-p4`
...
-   Add a status badge using this template: `[![<github_username>](https://circleci.com/gh/<github_username>/<repository>.svg?style=svg)](https://circleci.com/gh/<github_username>/<repository>)` replace `<github_username>` and `<repository>` with your data.
